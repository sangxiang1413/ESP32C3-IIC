...
{
	g_u8RxData[0] = IIC_Byte;
	I2C_Write(OLED_I2C_ADDR, (uint8_t *)g_u8RxData, 1);
...
//			OLED_P16x16Ch(i*16,0,i);
		...
		OLED_P8x16Str(0,0,(unsigned char *)"HelTec");//第一行 -- 8x16的显示单元显示ASCII码
		OLED_P8x16Str(0,2,(unsigned char *)"OLED Display");
		OLED_P8x16Str(0,4,(unsigned char *)"www.heltec.cn");
		OLED_P6x8Str(0,6,(unsigned char *)"cn.heltec@gmail.com");
		OLED_P6x8Str(0,7,(unsigned char *)"heltec.taobao.com");
		vTaskDelay(4000);
		OLED_CLS();
